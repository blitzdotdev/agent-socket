 ...
 */
export function exponentialBackoff(opts: { baseMs?: number; maxMs?: number; jitter?: number } = {}): DisconnectHandler {
 ...
 */
export function linearBackoff(opts: { delayMs?: number } = {}): DisconnectHandler {
 ...
 */
export function noBackoff(): DisconnectHandler {
